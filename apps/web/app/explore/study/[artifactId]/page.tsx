  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-8 px-6 py-16">
      ...
      <div className="flex flex-wrap gap-4 text-sm text-calm-muted">
        <Link href="/explore" className="underline hover:text-calm-text">Back to Explore</Link>
        <Link href="/login" className="underline hover:text-calm-text">Enter Brainpod</Link>
